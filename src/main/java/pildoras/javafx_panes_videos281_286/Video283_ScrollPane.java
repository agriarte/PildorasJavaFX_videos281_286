 ...
 * @author Pedro
 */
public class Video283_ScrollPane extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        miScrollPane.setMaxWidth(450);
        
        //política de mostrar barras scroll. Por defecto: AS_NEEDED. Otros valores: ALWAYS y NEVER
        miScrollPane.setVbarPolicy(ScrollPane.ScrollBarPolicy.ALWAYS);
