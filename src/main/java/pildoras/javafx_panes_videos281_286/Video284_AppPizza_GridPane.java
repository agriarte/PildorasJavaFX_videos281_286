 ...
 */
public class Video284_AppPizza_GridPane extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        miGridPane.add(paneBotones, 2, 5); // Agregar a la tercera columna "2" y fila 5
        //EL ALINEADO NO SE REALIZA, PARECE QUE ALGO ESTA AFECTANDO. MISMO RESULTADO CON LEFT, CENTER Y OMITIENDO
        GridPane.setHalignment(paneBotones, HPos.RIGHT);// <- NO FUNCIONA!
